...
export class ParametersController {
  ...
  @Get()
  findAll(@CurrentUser() user: CurrentUser, @Query() query: ListParametersQueryDto) {
  ...
  @Patch(':id')
  update(@CurrentUser() user: CurrentUser, @Param('id') id: string, @Body() dto: UpdateParameterDto) {
